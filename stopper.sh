...
if type postgresql >/dev/null 2>&1
    then 
        ...
        tell 0 "PostgresSQL is now stopped."
    else
...
if type cassandra >/dev/null 2>&1
    then
        ...
        tell 0 "Apache Cassandra is now stopped."
    else
